...
describe('v1beta2.AutoscalingPolicyServiceClient', () => {
    ...
    describe('createAutoscalingPolicy', () => {
        it('invokes createAutoscalingPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.CreateAutoscalingPolicyRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.AutoscalingPolicy());
        ...
        it('invokes createAutoscalingPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createAutoscalingPolicy(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataproc.v1beta2.IAutoscalingPolicy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateAutoscalingPolicy', () => {
        it('invokes updateAutoscalingPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.UpdateAutoscalingPolicyRequest());
            request.policy = {};
            request.policy.name = '';
    ...
    describe('getAutoscalingPolicy', () => {
        it('invokes getAutoscalingPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.GetAutoscalingPolicyRequest());
            request.name = '';
    ...
    describe('deleteAutoscalingPolicy', () => {
        it('invokes deleteAutoscalingPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.DeleteAutoscalingPolicyRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listAutoscalingPolicies', () => {
        it('invokes listAutoscalingPolicies without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.ListAutoscalingPoliciesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.AutoscalingPolicy()),
              generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.AutoscalingPolicy()),
              generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.AutoscalingPolicy()),
            ];
        ...
        it('invokes listAutoscalingPoliciesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataproc.v1beta2.AutoscalingPolicy[] = [];
                stream.on('data', (response: protos.google.cloud.dataproc.v1beta2.AutoscalingPolicy) => {
        ...
        it('uses async iteration with listAutoscalingPolicies without error', async () => {
            ...
            const responses: protos.google.cloud.dataproc.v1beta2.IAutoscalingPolicy[] = [];
