 ...
 */
  async checkCreateClusterProgress(name: string): Promise<LROperation<protos.google.cloud.dataproc.v1beta2.Cluster, protos.google.cloud.dataproc.v1beta2.ClusterOperationMetadata>>{
 ...
 * console.log(decodedOperation.metadata);
 */
  async checkUpdateClusterProgress(name: string): Promise<LROperation<protos.google.cloud.dataproc.v1beta2.Cluster, protos.google.cloud.dataproc.v1beta2.ClusterOperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
 ...
 * console.log(decodedOperation.metadata);
 */
  async checkDeleteClusterProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.dataproc.v1beta2.ClusterOperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
 ...
 * console.log(decodedOperation.metadata);
 */
  async checkDiagnoseClusterProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.dataproc.v1beta2.ClusterOperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
