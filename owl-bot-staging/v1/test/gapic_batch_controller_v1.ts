...
describe('v1.BatchControllerClient', () => {
    ...
    describe('getBatch', () => {
        it('invokes getBatch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetBatchRequest', ['name']);
    ...
    describe('deleteBatch', () => {
        it('invokes deleteBatch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteBatchRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createBatch', () => {
        it('invokes createBatch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateBatchRequest', ['parent']);
    ...
    describe('listBatches', () => {
        it('invokes listBatches without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListBatchesRequest', ['parent']);
            request.parent = defaultValue1;
