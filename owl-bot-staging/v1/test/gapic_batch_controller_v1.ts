...
describe('v1.BatchControllerClient', () => {
    ...
    describe('getBatch', () => {
        it('invokes getBatch without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1.GetBatchRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dataproc.v1.Batch());
            client.innerApiCalls.getBatch = stubSimpleCall(expectedResponse);
            const [response] = await client.getBatch(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getBatch as SinonStub)
    ...
    describe('deleteBatch', () => {
        it('invokes deleteBatch without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1.DeleteBatchRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteBatch as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('createBatch', () => {
        it('invokes createBatch without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createBatch as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listBatches', () => {
        it('invokes listBatches without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1.ListBatchesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listBatches as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
