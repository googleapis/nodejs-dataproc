...
describe('v1.JobControllerClient', () => {
    ...
    describe('submitJob', () => {
        it('invokes submitJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SubmitJobRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SubmitJobRequest', ['region']);
    ...
    describe('getJob', () => {
        it('invokes getJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetJobRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetJobRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetJobRequest', ['jobId']);
    ...
    describe('updateJob', () => {
        it('invokes updateJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdateJobRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('UpdateJobRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('UpdateJobRequest', ['jobId']);
            request.jobId = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}&job_id=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataproc.v1.Job()
    ...
    describe('cancelJob', () => {
        it('invokes cancelJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CancelJobRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('CancelJobRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('CancelJobRequest', ['jobId']);
            request.jobId = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}&job_id=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataproc.v1.Job()
    ...
    describe('deleteJob', () => {
        it('invokes deleteJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteJobRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteJobRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('DeleteJobRequest', ['jobId']);
            request.jobId = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}&job_id=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listJobs', () => {
        it('invokes listJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListJobsRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListJobsRequest', ['region']);
            request.region = defaultValue2;
