...
describe('v1.ClusterControllerClient', () => {
    ...
    describe('getCluster', () => {
        it('invokes getCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetClusterRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetClusterRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetClusterRequest', ['clusterName']);
    ...
    describe('createCluster', () => {
        it('invokes createCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateClusterRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('CreateClusterRequest', ['region']);
            request.region = defaultValue2;
    ...
    describe('updateCluster', () => {
        it('invokes updateCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdateClusterRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('UpdateClusterRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('UpdateClusterRequest', ['clusterName']);
            request.clusterName = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}&cluster_name=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('stopCluster', () => {
        it('invokes stopCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('StopClusterRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('StopClusterRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('StopClusterRequest', ['clusterName']);
            request.clusterName = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}&cluster_name=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('startCluster', () => {
        it('invokes startCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('StartClusterRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('StartClusterRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('StartClusterRequest', ['clusterName']);
            request.clusterName = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}&cluster_name=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deleteCluster', () => {
        it('invokes deleteCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteClusterRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteClusterRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('DeleteClusterRequest', ['clusterName']);
            request.clusterName = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}&cluster_name=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('diagnoseCluster', () => {
        it('invokes diagnoseCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DiagnoseClusterRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DiagnoseClusterRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('DiagnoseClusterRequest', ['clusterName']);
            request.clusterName = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}&cluster_name=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listClusters', () => {
        it('invokes listClusters without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListClustersRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListClustersRequest', ['region']);
            request.region = defaultValue2;
